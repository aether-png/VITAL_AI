      ...
      <section className="flex-1 relative overflow-y-auto transition-colors duration-300"
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none select-none z-10">
          ...
          <div className="text-center mt-12">
            <div className="text-7xl font-black tracking-tighter mb-4" style={{ color: 'var(--text-primary)', opacity: .04 }}>VITAL-AI</div>
            <p className="text-sm" style={{ color: 'var(--text-muted)' }}>Upload a patient CSV and run analysis to begin</p>
            <p className="text-xs mt-1" style={{ color: 'var(--text-muted)', opacity: .7 }}>CNN · MIMIC-III · 30-min window</p>
          </div>
        </div>
      </section>
    );
        ...
        <div className="grid grid-cols-3 gap-5 items-center fade-up d1">
          ...
          <div className="col-span-2 grid grid-cols-3 gap-4">
            ...
            <div className="glass p-4 rounded-xl flex flex-col justify-between min-h-[105px] relative overflow-hidden group">
              ...
              <span className="text-[10px] font-semibold uppercase tracking-widest" style={{ color: 'var(--text-muted)' }}>Patient ID</span>
              <div>
                <div className="text-xl font-mono font-bold" style={{ color: 'var(--text-primary)' }}>#PT-{data.patient_id}</div>
                <div className="text-[10px] mt-1" style={{ color: 'var(--text-muted)' }}>Selected subject</div>
              </div>
            </div>
            {/* Scan Time */}
            <div className="glass p-4 rounded-xl flex flex-col justify-between min-h-[105px] relative overflow-hidden group">
              ...
              <span className="text-[10px] font-semibold uppercase tracking-widest" style={{ color: 'var(--text-muted)' }}>Scan Time</span>
              <div>
                <div className="text-sm font-mono font-bold text-cyan-400 break-all">{data.occurrence_time || '—'}</div>
                <div className="text-[10px] mt-1" style={{ color: 'var(--text-muted)' }}>Last chart event</div>
              </div>
            </div>
            {/* Risk Score */}
            <div className="glass p-4 rounded-xl flex flex-col justify-between min-h-[105px] relative overflow-hidden border" style={{ borderColor: 'var(--border-glass)' }}>
              ...
              <div>
                ...
                <div className="w-full h-1 mt-2 rounded-full overflow-hidden" style={{ background: 'var(--badge-bg)' }}>
        ...
        <div className="grid grid-cols-2 gap-4 fade-up d2">
          ...
          <div className="glass rounded-xl p-5">
            <div className="flex justify-between items-center mb-3">
              <div>
                <h3 className="text-sm font-semibold" style={{ color: 'var(--text-primary)' }}>Standard Monitoring</h3>
                <p className="text-[10px] mt-0.5" style={{ color: 'var(--text-muted)' }}>Without AI Prediction Model</p>
              </div>
            </div>
            <div className="flex gap-3 mb-3 flex-wrap">
              <div className="flex items-center gap-1.5"><span className="w-3 h-0.5 bg-purple-400 rounded inline-block" /><span className="text-[10px]" style={{ color: 'var(--text-muted)' }}>SysBP</span></div>
              <div className="flex items-center gap-1.5"><span className="w-3 h-0.5 bg-red-400 rounded inline-block" /><span className="text-[10px]" style={{ color: 'var(--text-muted)' }}>MeanBP</span></div>
              <div className="flex items-center gap-1.5"><span className="w-3 h-0.5 bg-blue-400 rounded inline-block" /><span className="text-[10px]" style={{ color: 'var(--text-muted)' }}>HeartRate</span></div>
            </div>
          ...
          <div className="glass rounded-xl p-5">
            <div className="flex justify-between items-center mb-3">
              <div>
                <h3 className="text-sm font-semibold" style={{ color: 'var(--text-primary)' }}>AI-Enhanced Monitoring</h3>
                <p className="text-[10px] mt-0.5" style={{ color: 'var(--text-muted)' }}>With CNN Prediction Model</p>
              </div>
            </div>
            <div className="flex gap-3 mb-3 flex-wrap">
              <div className="flex items-center gap-1.5"><span className="w-3 h-0.5 bg-purple-400 rounded inline-block" /><span className="text-[10px]" style={{ color: 'var(--text-muted)' }}>SysBP</span></div>
              <div className="flex items-center gap-1.5"><span className="w-3 h-0.5 bg-red-400 rounded inline-block" /><span className="text-[10px]" style={{ color: 'var(--text-muted)' }}>MeanBP</span></div>
              <div className="flex items-center gap-1.5"><span className="w-3 h-0.5 bg-blue-400 rounded inline-block" /><span className="text-[10px]" style={{ color: 'var(--text-muted)' }}>HeartRate</span></div>
              <div className="flex items-center gap-1.5"><span className="w-2.5 h-2.5 rounded-full bg-red-500/40 inline-block border border-red-500" /><span className="text-[10px]" style={{ color: 'var(--text-muted)' }}>Hypotension Predicted</span></div>
            </div>
